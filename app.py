...
LEVELS = [
    # Class D color set to Light Silver (#C0C0C0)
...
TRANSLATIONS = {
    'en': {
        ...
        'rpg_quarterly_note': '(Distance resets every quarter: Apr-Jun, Jul-Sep, Oct-Dec 2026)',
    ...
    'th': {
        ...
        'countdown_label': 'เปิดซีซั่นชิงเสื้อในอีก:',
        # RPG Specific
        ...
        'xp_max': 'ระดับสูงสุด',
        'xp_desc': '(สะสมรายปี - รีเซ็ต 1 ม.ค. 69)',
        ...
        'rpg_quarterly_note': '(ระยะสะสมนับใหม่ทุกไตรมาส: เม.ย.-มิ.ย., ก.ค.-ก.ย., ต.ค.-ธ.ค. 69)',
